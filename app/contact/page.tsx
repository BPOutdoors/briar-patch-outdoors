            ...
            <div className="bg-white rounded-lg shadow p-6 space-y-5">
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <a
                    href="tel:+17067496994"
                    className="text-gray-600 hover:underline text-lg font-medium"
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <a
                    href="mailto:services@briarpatchoutdoors.com"
...
// Contact Form as a sub-component
function ContactForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    e.preventDefault()
    setSubmitting(true)
    // Will wire up to email API later — for now just show success
